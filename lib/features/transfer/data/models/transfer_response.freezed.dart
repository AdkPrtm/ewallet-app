...
/// @nodoc
abstract class _$$_TransferResponseCopyWith<$Res>
    implements $TransferResponseCopyWith<$Res> {
  factory _$$_TransferResponseCopyWith(
          _$_TransferResponse value, $Res Function(_$_TransferResponse) then) =
      __$$_TransferResponseCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({String? status, String? message, String? data});
}
...
/// @nodoc
class __$$_TransferResponseCopyWithImpl<$Res>
    extends _$TransferResponseCopyWithImpl<$Res, _$_TransferResponse>
    implements _$$_TransferResponseCopyWith<$Res> {
  __$$_TransferResponseCopyWithImpl(
      _$_TransferResponse _value, $Res Function(_$_TransferResponse) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_TransferResponse(
      status: freezed == status
          ? _value.status
          : status // ignore: cast_nullable_to_non_nullable
              as String?,
...
class _$_TransferResponse implements _TransferResponse {
  const _$_TransferResponse({this.status, this.message, this.data});

  factory _$_TransferResponse.fromJson(Map<String, dynamic> json) =>
      _$$_TransferResponseFromJson(json);
  ...
  @override
  String toString() {
    return 'TransferResponse(status: $status, message: $message, data: $data)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_TransferResponseCopyWith<_$_TransferResponse> get copyWith =>
      __$$_TransferResponseCopyWithImpl<_$_TransferResponse>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_TransferResponseToJson(
      this,
    );
  }
}
...
abstract class _TransferResponse implements TransferResponse {
  const factory _TransferResponse(
      {final String? status,
      final String? message,
      final String? data}) = _$_TransferResponse;
