...
class _AuthRemoteService implements AuthRemoteService {
  ...
  Future<HttpResponse<CheckDataResponse>> checkData({
    ...
    final value = CheckDataResponse.fromJson(_result.data!);
  ...
  Future<HttpResponse<RequestOTPResponse>> requestOTP({
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<RequestOTPResponse>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
      contentType: contentType,
  ...
  Future<HttpResponse<VerifyOTPResponse>> verifyOTP({
    ...
    _data.addAll(body);
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<VerifyOTPResponse>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
      contentType: contentType,
